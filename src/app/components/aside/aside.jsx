...
const AsideLinks = () => {
    return ( 
        <>
            <aside className="flex flex-col gap-5 w-[20%] justify-start sticky left-0 top-0 items-start h-screen border-r-[1px] border-white border-opacity-20">
                <Link href="/home" className="px-4 py-2 rounded-full mt-3 hover:bg-[#181818]">
